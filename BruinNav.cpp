...
////        cout << "not in the roster!" << endl;
////   
////    else
////        cout << "GPA is: " << *lindasGPA << endl;
////    MapLoader a;
////    a.load("/Users/zouweining/Downloads/skeleton/mapdata.txt");
////    cout<<a.getNumSegments()<<endl;
////    AttractionMapper b;
////    b.init(a);
////    GeoCoord g;
////    b.getGeoCoord("thalians mental health center", g);
////    SegmentMapper c;
////    c.init(a);
////    GeoCoord g("34.0668789", "-118.4038797");
////    c.getSegments(g);
//    Navigator* n = new Navigator;
//    vector<NavSegment> na;
//    n -> loadMapData("/Users/zouweining/Downloads/skeleton/mapdata.txt");
//    n -> navigate("Ruth Swissa Permanent Makeup and Skin;Bier Beisl", "Chanel", na);
//
//}
...
// and
//  ./BruinNav /Users/zouweining/Downloads/skeleton/mapdata.txt "Harvard-Westlake Middle School" "GreyStone Mansion" -raw
